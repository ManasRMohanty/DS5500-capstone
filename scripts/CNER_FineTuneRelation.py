...
from transformers import BertTokenizer, BertConfig, BertForSequenceClassification, get_linear_schedule_with_warmup, AdamW, BertConfig, BertModel
import nltk
import numpy as np
import torch
import pickle
...
input_ids = pickle.load(open("C:/Users/itsma/Documents/Capstone project/relation_encodings.pkl","rb"))
#event_labels = pickle.load(open("/home/itsmanasmohanty/event_labels.pkl","rb"))
labels = pickle.load(open("C:/Users/itsma/Documents/Capstone project/relation_labels.pkl","rb"))
